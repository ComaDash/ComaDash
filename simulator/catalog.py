...
SIGNALS: list[Signal] = [
    ...
    Signal("AguaAlimentacion", "BombaAlimentacion", "VibracionBombaRMS", "mm/s", 1.6, 0.08, "PMP_AF_01"),
    Signal("AguaAlimentacion", "BombaAlimentacion", "VibracionBombaFFTAlta", "mm/s", 0.45, 0.03, "PMP_AF_01"),
    Signal("AguaAlimentacion", "BombaAlimentacion", "PresionDescargaBomba", "bar", 58.0, 0.6, "PT_AF_01"),
